...
**Reference implementation in this repo:** see `.github/workflows/daily-digest.yml`, `scripts/daily-digest.sh`, and [`.github/workflows/README.md`](../../.github/workflows/README.md) for setup (Discussions, Slack webhook, Anthropic key).
